...
<body>
	...
	<div>
		<p class="center_text">SE VUOI LAVORARE CON NOI INVIACI I TUOI DATI </br>E IL TUO CURRICULUM NELL'APPOSITO FORM </br> O VIA MAIL A: cv.acquarea@gmail.com</br> </p>
	</div>
	...
	<form method="post" action="create_news.php" enctype="multipart/form-data">
		...
		<div class="input-group">
			<button type="submit" class="btn" name="cv_request">Invia Richiesta</button>
		</div>
	</form>
