/*IN QUESTO FOGLIO SONO CONTENUTI TUTTI I DATI DELLE PISCINE, DELLE PERSONE FACENTI PARTE DELLA PALESTRA
STAFF, ISCRITTI E DEGLI UTENTI ISCRITTI AL SITO WEB I QUALI POSSONO INTERAGIRE PER VEDERE I CORSI A CUI SONO ISCRITTI
...
Mail VARCHAR(50) UNIQUE REFERENCES Utente(Email)
);
...
CodFiscale VARCHAR (16) UNIQUE REFERENCES Persona(CF)
);
